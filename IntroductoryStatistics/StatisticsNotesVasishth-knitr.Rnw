...
<<'child-01introduction.Rnw', child='01introduction-knitr.Rnw'>>=
@

%%SDSM

<<'child-02RepeatedSampling.Rnw', child='02RepeatedSampling-knitr.Rnw'>>=
@

<<'child-03TrueFalseDiscoveryRate.Rnw', child='03TrueFalseDiscoveryRates-knitr.Rnw'>>=
@
