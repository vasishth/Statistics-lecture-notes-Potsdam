...
This is a (simulated) \textbf{sample}; we could have taken a different sample from the population of German speakers. You can simulate that by running the above code again.
